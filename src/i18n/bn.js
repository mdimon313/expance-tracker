export default {
  ...
  auth: {
    ...
    biometricLogin: "ফেস আইডি / ফিঙ্গারপ্রিন্ট দিয়ে লগইন",
  ...
  transaction: {
    ...
    noTransactionsSubtitle: "আজই আপনার খরচ ট্র্যাক করা শুরু করুন।",
    filterSort: "ফিল্টার ও সাজান",
    month: "মাস",
    allMonths: "সব মাস",
    sort_newest: "নতুন থেকে পুরোনো",
    sort_oldest: "পুরোনো থেকে নতুন",
    sort_highest: "সর্বোচ্চ পরিমাণ",
    sort_lowest: "সর্বনিম্ন পরিমাণ",
  },
  budget: {
    title: "বাজেট",
    spent: "খরচ হয়েছে",
    ...
    noBudgetsTitle: "আপনার প্রথম বাজেট তৈরি করুন",
    noBudgetsSubtitle: "আপনার মাসিক খরচ নিয়ন্ত্রণ করুন।",
  },
  savings: {
  ...
  settings: {
    ...
    locationPermission: "লোকেশন অনুমতি",
    allowed: "অনুমোদিত",
    denied: "প্রত্যাখ্যাত",
    light: "লাইট",
    dark: "ডার্ক",
    ...
    logout: "লগ আউট",
    biometricLoginToggle: "বায়োমেট্রিক লগইন চালু করুন",
  },
  category: {
    food: "খাবার",
    transport: "যাতায়াত",
