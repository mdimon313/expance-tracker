export default {
  ...
  transaction: {
    ...
    noTransactionsSubtitle: "Start tracking your spending today.",
  ...
  budget: {
    ...
    noBudgetsTitle: "Create your first budget",
    noBudgetsSubtitle: "Take control of your monthly spending.",
  },
  savings: {
  ...
  settings: {
    ...
    logout: "Log Out",
    biometricLoginToggle: "Enable Biometric Login",
  },
  category: {
    food: "Food",
    transport: "Transport",
